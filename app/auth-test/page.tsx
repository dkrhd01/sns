...
export default function AuthTestPage() {
  ...
  const testConnection = useCallback(async () => {
    try {
      ...
      console.error("Connection test error RAW:", err);
      console.error("Connection test error parsed:", {
  ...
  const fetchOrCreateUser = useCallback(async () => {
    ...
    try {
      ...
      console.error("Fetch or create user error RAW:", err);
      console.error("Fetch or create user error parsed:", {
        message: (err as any)?.message,
        code: (err as any)?.code,
        details: (err as any)?.details,
        hint: (err as any)?.hint,
  ...
  const updateName = async () => {
    ...
    try {
      ...
      console.error("Update name error RAW:", err);
      console.error("Update name error parsed:", {
        message: (err as any)?.message,
        code: (err as any)?.code,
        details: (err as any)?.details,
        hint: (err as any)?.hint,
